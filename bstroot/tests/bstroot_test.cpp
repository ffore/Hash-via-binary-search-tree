...
TEST_CASE("copy constructor", "[copycons]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> cc;
	cc.insert(26, 'Z');
	cc.insert(3, 'C');
	cc.insert(8, 'H');
	cc.insert(1, 'A');
	cc.insert(5, 'E');
	cc.insert(2, 'B');
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> ccnew(cc);
	REQUIRE(ccnew.inorder_print() == cc.inorder_print());
	const cop3530::BSTROOT<int,char,*compare_int,*equality_int> constcc(cc); 
	//constcc.remove(1);/*uncomment to throw compiler error cannot modify const tree*/
}

TEST_CASE("copy assignment", "[copyasgmt]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> ca;
	ca.insert(26, 'Z');
	ca.insert(3, 'C');
	ca.insert(8, 'H');
	ca.insert(1, 'A');
	ca.insert(5, 'E');
	ca.insert(2, 'B');
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> ca1;
	ca1.insert(13, 'M');
	ca1.insert(15, 'O');
	ca1.insert(14, 'N');
...
TEST_CASE("move constructor", "[moveconst]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> mc;
	mc.insert(19, 'S');
	mc.insert(17, 'Q');
	mc.insert(15, 'O');
	mc.insert(10, 'J');
	...
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> movedmc(std::move(mc));
...
TEST_CASE("move assignment", "[moveasmgt]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> ma;
	ma.insert(19, 'S');
	ma.insert(17, 'Q');
	ma.insert(15, 'O');
	ma.insert(10, 'J');
	...
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> ma1;
	ma1.insert(26, 'Z');
	ma1.insert(3, 'C');
	ma1.insert(8, 'H');
	ma1.insert(1, 'A');
...
TEST_CASE("testing insert matches inorder print", "[insert to inorder print]"){
	//std::cout << "==========TEST1==========" << std::endl;	
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test1;
	test1.insert(5, 'E');
	REQUIRE(test1.get_root() == 5);
	test1.insert(2, 'B');
	REQUIRE(test1.get_root() == 2);
	REQUIRE(test1.inorder_print() == "2B 5E ");
	test1.insert(26, 'Z');
	REQUIRE(test1.get_root() == 26);
	test1.insert(3, 'C');
	REQUIRE(test1.get_root() == 3);
	test1.insert(8, 'H');
	REQUIRE(test1.get_root() == 8);
	test1.insert(1, 'A');
	REQUIRE(test1.get_root() == 1);
	...
	//testing remove(1)
	test1.remove(1);
	REQUIRE(test1.inorder_print() == "2B 3C 8H 26Z ");
	test1.insert(9, 'I');
	REQUIRE(test1.inorder_print() == "2B 3C 8H 9I 26Z ");
	test1.remove(26);
	REQUIRE(test1.inorder_print() == "2B 3C 8H 9I ");
	test1.insert(6, 'F');
	REQUIRE(test1.inorder_print() == "2B 3C 6F 8H 9I ");
}

TEST_CASE("testing remove on various trees", "[remove]"){
	//std::cout << "==========TEST2==========" << std::endl;
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test2a;
	...
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test2b;
...
TEST_CASE("testing lookup", "[lookup]"){
	...
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test3a;
	...
	test3a.remove(5);
	test3a.remove(2);
	REQUIRE_THROWS(test3a.remove(2));
	REQUIRE_THROWS(test3a.remove(99));
	REQUIRE_THROWS(test3a.remove(-2));
	test3a.insert(8, 'H');test3a.insert(12, 'L');test3a.insert(5, 'E');
	test3a.remove(6);
	test3a.remove(10);
	REQUIRE(test3a.inorder_print() == "1A 3C 4D 5E 8H 12L 15O ");
	...
	REQUIRE_THROWS(test3a.lookup(99));
	REQUIRE_THROWS(test3a.lookup(-9));
}

TEST_CASE("testing contains/size/clear/isempty", "[contains]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test1h;
	...
	test1h.insert(18, 'R');
	test1h.insert(14, 'N');
	REQUIRE(test1h.balance() == 0);	//tested on paper
...
TEST_CASE("testing height", "[height]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test1i;
...
TEST_CASE("same as avl remove1f", "[remove1n]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test1n;
	test1n.insert(22, 'V');
	test1n.insert(18, 'R');
	test1n.insert(20, 'T');
	test1n.insert(19, 'S');
...
TEST_CASE("same as avl remove1g", "[remove1o]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test1o;
	test1o.insert(26, 'Z');
	test1o.insert(5, 'E');
	test1o.insert(20, 'T');
	test1o.insert(13, 'M');
...
TEST_CASE("same as avl remRR", "[remove1p]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test1p;
	test1p.insert(5, 'E');
	test1p.insert(3, 'C');
	test1p.insert(10, 'J');
	test1p.insert(2, 'B');
...
TEST_CASE("same as avl remRL", "[remove1q]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test1q;
	test1q.insert(5, 'E');
	test1q.insert(3, 'C');
	test1q.insert(10, 'J');
	test1q.insert(2, 'B');
...
TEST_CASE("same as avl remLL", "[remove1r]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test1r;
	test1r.insert(15, 'O');
	test1r.insert(10, 'J');
	test1r.insert(17, 'Q');	
	test1r.insert(7, 'G');
...
TEST_CASE("same as avl remLR", "[remLR]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test1s;
	test1s.insert(15, 'O');
	test1s.insert(10, 'J');
	test1s.insert(17, 'Q');	
	test1s.insert(7, 'G');
...
TEST_CASE("testing is_empty", "[empty]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> test1t;
...
TEST_CASE("github", "[github]"){
	cop3530::BSTROOT<int,char,*compare_int,*equality_int> git;
